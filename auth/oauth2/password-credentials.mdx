---
title: "How to Use OAuth2 for the Password Credentials Grant Type"
---
...
<video controls className="mt-10">
  <source
    src="/screenrecordings/oauth2/password-credentials-collection-level.mp4"
    type="video/mp4"
  />
...
<video controls className="mt-10">
  <source
    src="/screenrecordings/oauth2/password-credentials-request-level.mp4"
    type="video/mp4"
  />
  Your browser does not support the video tag.
</video>
