...
![Open the collection's dropdown menu](/images/screenshots/migration/postman/postman-pre-dropdown.webp)

![Find the export button](/images/screenshots/migration/postman/postman-dropdown.webp)

A popup dialog will appear, select either `Collection v2` or `Collection v2.1` format and click on the `Export` button.

![Export collection dialog](/images/screenshots/migration/postman/postman-export-dialog.webp)
...
![Open the environment's dropdown menu](/images/screenshots/migration/postman/postman-environment.webp)
