...
<Info>
  If you have an existing collection inside of another tool that you would like to import, please see [Importing Collections <strong><sup>↗</sup></strong>](https://docs.usebruno.com/import-export-data/import-collections).
</Info>
...
[Add a request <strong><sup>↗</sup></strong>](https://docs.usebruno.com/bruno-basics/create-a-request) to your collection as a next step!
