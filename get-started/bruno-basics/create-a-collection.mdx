...
![create collection dialog](/images/screenshots/get-started/bruno-basics/create-collection/bruno_collection-1.webp)

3. Enter a name for your collection
4. Choose a location on your filesystem to store the collection

![create collection dialog](/images/screenshots/get-started/bruno-basics/create-collection/bruno_collection-2.webp)
