...
![preferences](/images/screenshots/get-started/config/proxy/1-preferences.webp)

3. Navigate to the **Proxy** tab in the sidebar.

![proxy-settings](/images/screenshots/get-started/config/proxy/2-global-proxy.webp)
