...
![select-run.webp](/images/screenshots/testing/1-select-run.webp)

3. Click **Run Collection** to initiate the test.

![click-runner.webp](/images/screenshots/testing/2-click-runner.webp)
...
![Reorder Requests](/images/screenshots/testing/reorder-req.webp)
