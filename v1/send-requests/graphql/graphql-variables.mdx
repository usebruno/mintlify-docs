...
2. **Define Variables**:
  ...
  ![query-graphql](/images/screenshots/send-request/graphql/adding-var-graphql.webp)
...
![query-graphql](/images/screenshots/send-request/graphql/using-var-in-graphql.webp)
