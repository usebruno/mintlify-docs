...
![Request Headers](/images/screenshots/send-request/res-data-and-cookie/res-headers.webp)
...
![Save Response](/images/screenshots/send-request/res-data-and-cookie/save-res/save-response.webp)
...
![Save Response to File](/images/screenshots/send-request/res-data-and-cookie/res-save.webp)

### Clear Response

If you want to reset or clear the response data, you can easily do so using the clear response option.

![Clear Response](/images/screenshots/send-request/res-data-and-cookie/res-clear.webp)
...
![Raw Response](/images/screenshots/send-request/res-data-and-cookie/res-raw.webp)
