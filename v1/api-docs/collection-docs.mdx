...
![collection-settings](/images/screenshots/send-request/api-docs/collection-settings-docs.webp)
...
![collection-preview](/images/screenshots/send-request/api-docs/save-collection-docs.webp)
