...
<img src="/images/screenshots/sso-scim-management/bruno-scim/scim-settings-1.webp" alt="Enable SCIM in Bruno license portal" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/bruno-scim/scim-settings-2.webp" alt="Generate SCIM API Key in Bruno license portal" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
