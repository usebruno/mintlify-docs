...
<img src="/images/screenshots/sso-scim-management/saml-sso/bruno-sso-settings.webp" alt="Bruno SSO Configuration settings page" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-0.webp" alt="Bruno SSO Configuration settings page" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-1.webp" alt="Select SAML as single sign-on method in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-2.webp" alt="Select SAML as single sign-on method in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-3.webp" alt="Configure basic SAML settings in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-5.webp" alt="Configure attributes and claims in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-6.webp" alt="Configure unique user identifier in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-7.webp" alt="Configure roles claim in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-8.webp" alt="Configure fullName claim in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-9.webp" alt="Finalized attributes and claims configuration in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-10.webp" alt="Copy SSO URL from Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-11.webp" alt="Paste SSO URL into Bruno SSO settings" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-12.webp" alt="Download SAML certificate from Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-10.webp" alt="Paste SAML certificate into Bruno SSO settings" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-11.webp" alt="Configure role mapping in Bruno License Portal" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/entra/entra-sso-13.webp" alt="Assign users or groups to Bruno app in Entra ID" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/saml-sso/bruno-lic-mgr-loginwsso.webp" alt="Login with SSO in Bruno License Portal" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
