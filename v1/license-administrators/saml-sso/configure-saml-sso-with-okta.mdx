---
title: "Configure SAML SSO with Okta"
---
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-4.webp" alt="Bruno SSO Configuration settings page with SAML ACS URL and SP Issuer ID / Entity ID highlighted" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-swa-1.webp" alt="Create App Integration in Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

4. Select **SAML 2.0** as the sign-in method
5. Click **Next**

<img src="/images/screenshots/sso-scim-management/okta/okta-sso-1.webp" alt="Select SAML 2.0 as sign-in method" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-2.webp" alt="Configure general settings for Bruno SAML app in Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-3.webp" alt="Configure Audience URI (SP Entity ID) in Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-5.webp" alt="Configure attribute statements in Okta showing roles and fullName" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-6.webp" alt="Complete Okta app setup" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-7.webp" alt="Copy SAML metadata from Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-9.webp" alt="Paste SSO URL into Bruno SSO settings" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-8.webp" alt="Download SAML certificate from Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-12.webp" alt="Configure session timeout in Bruno License Portal" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/images/screenshots/sso-scim-management/okta/okta-sso-13.webp" alt="Assign users or groups to Bruno app in Okta" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
