...
<div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', marginTop: '1rem' }}>
  <img
    src="/images/screenshots/migration/postman/postman-pre-dropdown.webp"
    alt="Open the collection's dropdown menu"
    style={{ width: '500px', borderRadius: '0.5rem' }}
  />
  <img
    src="/images/screenshots/migration/postman/postman-dropdown.webp"
    alt="Find the export button"
    style={{ width: '200px', marginLeft: '2.5rem', borderRadius: '0.5rem' }}
  />
</div>
...
<img
  src="/images/screenshots/migration/postman/postman-export-dialog.webp"
  alt="Export collection dialog"
  style={{ width: '400px', marginTop: '1rem', borderRadius: '0.5rem' }}
/>
...
<img
  src="/images/screenshots/migration/postman/postman-environment.webp"
...
![Import Environment New](/images/screenshots/get-started/import-export/import-postman-environment/import-environment-new.webp)

5. Click on **Import environment**

![Import Postman Environment](/images/screenshots/get-started/import-export/import-postman-environment/import-environment.webp)
...
![Bruno Environment](/images/screenshots/get-started/import-export/import-postman-environment/import-postman-environment-bottom.webp)
