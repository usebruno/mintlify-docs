---
title: "Collaboration via Bitbucket"
---
...
![bitbucket-create-repository](/images/screenshots/git-integration/bitbucket-gitlab/bit-create-project.webp)

Once you create a repository, click on the **Clone** button and copy the URL, which looks similar to:

![bitbucket-clone-repository](/images/screenshots/git-integration/bitbucket-gitlab/bit-clone-repo.webp)
...
![bitbucket-add-ssh-key](/images/screenshots/git-integration/bitbucket-gitlab/bit-add-ssh.webp)
