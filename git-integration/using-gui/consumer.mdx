...
![Enter Repository URL](/images/screenshots/git-integration/git-gui/consumer/3-enter-repo-url.webp)
...
![Pull Changes](/images/screenshots/git-integration/git-gui/10-pull-changes.webp)
