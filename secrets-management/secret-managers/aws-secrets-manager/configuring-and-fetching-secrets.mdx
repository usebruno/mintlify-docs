...
![Select AWS Secrets Manager Provider](/images/screenshots/secret-variables/aws-secret-manager/4-select-aws-secrets.webp)
...
![AWS Secret Configuration Dialog](/images/screenshots/secret-variables/aws-secret-manager/5-aws-secret-dialog-box.webp)
...
![Fetch Secrets from AWS](/images/screenshots/secret-variables/aws-secret-manager/6-aws-fetch-secrets.webp)
