---
title: "Adding AWS Secrets Manager"
---
...
1. **Access Secrets Manager Settings**
   ...
   ![Open Secrets Manager](/images/screenshots/secret-variables/aws-secret-manager/1-aws-secret-manager-dialog.webp)

2. **Add a New Secret Provider**
   - Click the `+ Add Secret Provider` button.
   - Select **AWS Secrets Manager** as the provider type.

   ![AWS Secret Manager Dialog](/images/screenshots/secret-variables/aws-secret-manager/2-secret-manager-option.webp)
...
3. **Enter AWS Credentials**
   - Fill in the required fields:
     ...
     - **Region**
      ...
      ![Configure AWS Secrets](/images/screenshots/secret-variables/aws-secret-manager/3-config-aws-secrets.webp)
