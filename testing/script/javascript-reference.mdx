...
| bru.deleteGlobalEnvVar(key) | Deletes a specific global environment variable.         |
...
- **`deleteGlobalEnvVar(key)`** - Delete a specific global environment variable.
  ```javascript
  bru.deleteGlobalEnvVar("api_key");
  ```
...
- **`deleteAllGlobalEnvVars()`** - Delete all global environment variables.
  ```javascript
...
| bru.deleteCollectionVar(key) | Deletes a specific collection variable.                   |
| bru.deleteAllCollectionVars() | Deletes all collection variables.                        |
| bru.getAllCollectionVars()   | Retrieves all collection variables as an object.         |
...
- **`setCollectionVar(key, value)`** - Set a collection-level variable.
  ```javascript
  bru.setCollectionVar("namespace", "production");
  ```
...
- **`deleteCollectionVar(key)`** - Delete a specific collection variable.
  ```javascript
  bru.deleteCollectionVar("namespace");
  ```
...
- **`getAllCollectionVars()`** - Get all collection variables as an object.
  ```javascript
  const collectionVars = bru.getAllCollectionVars();
  console.log(collectionVars);
  ```
