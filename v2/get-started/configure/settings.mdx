...
![general-settings](/v2/images/screenshots/get-started/config/settings/general-settings.webp)
...
![display-settings](/v2/images/screenshots/get-started/config/settings/display-settings.webp)
...
![proxy-settings](/v2/images/screenshots/get-started/config/settings/proxy-settings.webp)
...
![license-settings](/v2/images/screenshots/get-started/config/settings/license-settings.webp)

## Keybindings

The Keybindings section provides details about Bruno's keyboard shortcuts.

![keybindings](/v2/images/screenshots/get-started/config/settings/key-settings.webp)
...
![vault-secrets](/v2/images/screenshots/get-started/config/settings/vault-server.webp)
...
![support](/v2/images/screenshots/get-started/config/settings/support.webp)

## About

View application details and enable the auto-update feature to keep your app up to date automatically.

![about](/v2/images/screenshots/get-started/config/settings/about.webp)
