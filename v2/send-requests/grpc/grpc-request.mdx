...
![gRPC Interface](/v2/images/screenshots/send-request/grpc/1-grpc-interface.webp)
...
![Create gRPC Request](/v2/images/screenshots/send-request/grpc/2-create-grpc-req.webp)
...
![Select Method](/v2/images/screenshots/send-request/grpc/3-select-method.webp)
...
![Add Message and Receive Response](/v2/images/screenshots/send-request/grpc/4-add-msg-receive-resp.webp)
