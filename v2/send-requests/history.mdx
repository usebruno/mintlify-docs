...
![navigate history](/v2/images/screenshots/get-started/history/navigate-history.webp)

3. You will have access to the complete request activity log.

![history log](/v2/images/screenshots/get-started/history/history_log.webp)
