...
![login](/v2/images/screenshots/license-management/activatelicense.webp)
...
<Info>
SSO license activation is available for Ultimate Edition customers. Please see the [SAML SSO Overview](/v2/license-administrators/saml-sso/overview) for more information.
</Info>
...
![login](/v2/images/screenshots/license-management/activate-sso.webp)

<Info>
Your email needs to be part of the SSO configuration in order to activate your license, with the `User Role` mapped. See [Role Mapping](/v2/license-administrators/saml-sso/overview#role-mapping) for details.
</Info>
...
![login](/v2/images/screenshots/license-management/activate-message-success.webp)
