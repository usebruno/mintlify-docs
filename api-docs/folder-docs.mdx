...
![create-folder](/images/screenshots/send-request/api-docs/create-folder.webp)

2. Enter a name for the folder and click the **Create button**.
3. After creating the folder, navigate to the folder settings.

![folder-level-setting](/images/screenshots/send-request/api-docs/folder-level-settings.webp)
