...
Once `AGENTS.md` is in place, Codex can generate Bruno collections from your API source code, write pre-request and test scripts, and help with CI/CD workflows. Reference Bruno's [JavaScript API Reference](/testing/script/javascript-reference) and [Bru Lang](/bru-lang/overview) in your instructions so Codex produces valid Bruno files.
